			...
			<div className='container'>
				...
				<div className='flex justify-between m-auto'>
					<div className='flex flex-col mr-[15px]'>
						<div className='w-[550px] bg-[#e1a421] text-white px-[20px] py-[10px] rounded-2xl text-[30px] mb-[30px] h-[300px]'>
						...
						<div className='w-[550px] bg-[#e1a421] text-white px-[20px] py-[10px] rounded-2xl text-[30px] h-[300px]'>
