				...
				<div className='flex justify-between items-center'>
					<div className='max-w-[600px] flex flex-col items-center'>
						<div className='mt-[40px] text-[23px] 2xl:text-[30px]'>
							...
							цьому. Мене завжди дратувало, що ці талановиті люди не бачать
							свого потенціалу і зливають його на роботу, яка насправді не
							вартує їх уваги. І в той же самий час я не бачила своїх талантів,
							отже і не цінувала себе, через це я не могла себе реалізувати.
						</div>
						<Image
							src='/comment.png'
							alt='comment'
