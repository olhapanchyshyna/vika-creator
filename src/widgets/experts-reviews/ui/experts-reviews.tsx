				...
				<div className='flex justify-between '>
					<div className='flex flex-col items-start w-[600px]'>
						<div className='text-[30px]'>
							<h2 className="text-[55px] text-[#e1a421] font-black">
								Айті школа
							</h2>
							<div className='text-[30px]'>
								<span className='font-bold text-[30px]'>Що робили? </span>
								<br /> Розпаковку особистості та автентичності, частково
								переупакували курси, зробили прогрів побудовний на автентичності
								та історії експерта Масштабування з 350 000 грн на 663 572 грн
							</div>
						</div>
						<Image
							src='/about-me.jpg'
